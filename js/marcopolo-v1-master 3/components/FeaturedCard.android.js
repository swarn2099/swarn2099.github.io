...
const FeaturedCard=props=>{
  let {image,type,name,time,date,initial,interested,...rest}=props;
  ...
  return (
    ...
    <View style={{flexDirection:'row',justifyContent:'space-between',}}>
      ...
      <View style={{flexDirection:'row'}}>
        ...
        <View style={{backgroundColor:'white',width:200,width: 200, paddingLeft: 90, paddingTop: 6}}>
        <Button rounded style={{padding:25}}onPress={()=>addRandomPost(initial)}><Feather name="thumbs-up"{...buttonProps}/></Button>
        </View>
        </View>
      </View>
    </Card>
